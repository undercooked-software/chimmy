...
/* GP2X Wiz specific flags */
#define WIZ_MMUHACKOFF	0x00040000	/* modified by ikari 2010.3.11 */
#define WIZ_RAMTWEAKOFF	0x00080000	/* modified by ikari 2010.3.11 */
#define WIZ_240X320	0x00100000	/* modified by ikari 2010.1.29 */
#define WIZ_UPPERSURFACE 0x00200000	/* modified by ikari 2010.2.18 */
#define WIZ_TEARING	0x00400000	/* modified by ikari 2010.2.18 */
#define WIZ_VSYNCOFF	0x00800000	/* modified by ikari 2010.2.28 */
...
#if 0
extern DECLSPEC void SDLCALL SDL_GetDRMNumber(unsigned char * buf);	// jhkang 081110
extern DECLSPEC void SDLCALL SDL_GetSerialNumber(unsigned char * buf);	// jhkang 081110
#endif
...
extern DECLSPEC int SDL_WizRotateBlitSurface(SDL_Surface *src, SDL_Surface *dst, SDL_Rect *rect);
