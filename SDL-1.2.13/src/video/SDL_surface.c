			...
			Uint32 Rmask, Uint32 Gmask, Uint32 Bmask, Uint32 Amask)
{
	...
	if ( screen )
	{
		if((screen->flags&WIZ_UPPERSURFACE) != WIZ_UPPERSURFACE)
	...
	/* Get the pixels */
#if SDL_VIDEO_DRIVER_GP2XWIZ /* modified by ikari 2010.2.21 */
	if ( (((flags&SDL_HWSURFACE) == SDL_SWSURFACE) && ((flags&WIZ_UPPERSURFACE) != WIZ_UPPERSURFACE)) || 
...
#if !SDL_VIDEO_DRIVER_GP2XWIZ /* modified by ikari 2010.2.27 */
