...
#undef SDL_PROC
	...
	*/
	...
	int _fb_fd;
	unsigned int fb1_realaddr[4];
	volatile unsigned int *_memregs32;
	volatile unsigned short *_memregs16;
	void* shadow_pixels;
	unsigned int shadow_pitch;
	unsigned int rotate_screen;
	unsigned int mmuhack_type;
	unsigned int width_odd;
	unsigned int tvout_mode;
#ifdef GP2XWIZ_ROTATIONBUFFER
	SDL_Surface* rotation_buffer;
#endif
#endif
...
extern VideoBootStrap GP2XWIZ_bootstrap;
#endif
...
#if SDL_VIDEO_DRIVER_GP2XWIZ /* modified by ikari 2010.1.23 */
#define fb_fd			(this->_fb_fd)
#define memregs32		(this->_memregs32)
#define memregs16		(this->_memregs16)

#define MLC_PRI_ENABLED 0x1
#define MLC_SEC_ENABLED 0x2
#endif
